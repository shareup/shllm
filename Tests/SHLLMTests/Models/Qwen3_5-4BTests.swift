...
struct Qwen3_5_4BTests {
    ...
    func canStreamResult() async throws {
        ...
        guard let llm = try qwen3_5__4B(input) else { return }
    ...
    func canUseStockToolAndRespond() async throws {
        ...
        guard let llm1 = try qwen3_5__4B(
            input,
            tools: [stockTool]
        ) else { return }
        ...
        guard let llm2 = try qwen3_5__4B(
            input,
            tools: [stockTool]
        ) else { return }
    ...
    func canCompleteMultiToolWorkflowAndEmail() async throws {
        ...
        var input = UserInput(chat: chat)
        guard let llm = try qwen3_5__4B(input, tools: [
        ...
        guard let llm2 = try qwen3_5__4B(input, tools: [
            webSearchTool, fetchPageTool, findEmailTool, sendEmailTool,
        ]) else { return }
        ...
        guard let llm3 = try qwen3_5__4B(input, tools: [
            webSearchTool, fetchPageTool, findEmailTool, sendEmailTool,
        ]) else { return }
        ...
        guard let llm4 = try qwen3_5__4B(input, tools: [
            webSearchTool, fetchPageTool, findEmailTool, sendEmailTool,
        ]) else { return }
        ...
        guard let llm5 = try qwen3_5__4B(input, tools: [
            webSearchTool, fetchPageTool, findEmailTool, sendEmailTool,
        ]) else { return }
    ...
    func canExtractTextFromImageData() async throws {
        ...
        guard let llm = try qwen3_5__4B(image: data) else { return }
    ...
    func canExtractTextFromImageURL() async throws {
        ...
        guard let llm = try qwen3_5__4B(image: url) else { return }
...
private func qwen3_5__4B(
    _ input: UserInput,
    tools: [any ToolProtocol] = []
) throws -> LLM<Qwen35>? {
    try loadModel(
        directory: LLM<Qwen35>.qwen3_5__4B,
        input: input,
        tools: tools,
